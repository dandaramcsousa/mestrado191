...
estatisticas %>%
  ...
  theme(axis.title.x = element_blank(), axis.title.y = element_blank(), axis.text.y = element_blank(), panel.grid.major.x = element_blank(), panel.background = element_rect(colour = "black", size=1)) +
  labs(title = "Tendência a doar")
...
extremapobreza <- experimento %>%
  ...
  theme(axis.title.y = element_blank(), axis.title.x = element_blank(), panel.grid.major.x = element_blank(), panel.background = element_rect(colour = "black", size=1)) +
  labs(title = "Crianças em extrema pobreza") 
extremapobreza
...
ggsave("../data/distribuicoes.png",width=8, height=4)
```
